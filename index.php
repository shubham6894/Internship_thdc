...
<body>
		...
		<div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
			<ul class="navbar-nav">
				<li class="nav-item active">
					<a class="nav-link" href="guests_control_page.php" style="font-family: 'Luckiest Guy'; font-size: 20px;}">
						GUESTS
						<span class="sr-only">
							(current)
						</span>
				...
				<li class="nav-item active">
					<a class="nav-link" href="events_control_page.php" style="font-family: 'Luckiest Guy'; font-size: 20px;">
						EVENTS
						<span class="sr-only">						
						</span>
					</a>
	...
	<div class="jumbotron text-white" style="background-image: url('RSVP_IMAGES/homebackground.jpg'); font-family: Paprika;" >
		<center>
			<h1 style="font-family: 'Cabin Sketch'; font-size: 60px; color: peachpuff;"> 
				----THE LATEST EVENT <span class="badge badge-primary">Soiree</span>----
			</h1>
		<?php
				...
				<center>
					<div class="container">
						<div style="width: 100%; border: 2px dashed gray; padding-bottom:45px">
							<h5 style="font-family: 'Margarine'; font-size: 23px; padding-top:45px;">
								Confirm your RSVP status <span class="badge badge-danger">click on the button below</span>
							</h5>
			...
			<div class="col-lg-6">
				<center>
					<div class="container">
						<div style="width: 100%; border: 2px dashed gray; padding-bottom:45px;"	>
							<h5 style="font-family: 'Margarine'; font-size: 23px; padding-top:45px; ">
								Want to join the party? <span class="badge badge-primary">click on the button below</span>
							</h5>
	...
	<div class="container-fluid">
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content"> 
					  	<div class="modal-header">
							<h3 class="modal-title" id="exampleModalLongTitle" style="font-family: 'Bangers'; font-size: 30px;">
								NEW RSVP
							</h3>
					    ...
					    <div class="modal-footer">
							<button type="button" class="btn btn-success" id="Submit_rsvp">
								GET LINK
							</button>
		...
		<div class="container">
			<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
			  	<div class="modal-dialog" role="document">
					<div class="modal-content">
					  	<div class="modal-header">
							<h3 class="modal-title" id="exampleModalLabel" style="font-family: 'Bangers'; font-size: 30px;">
								NEW REQUEST
							</h3>
							<button type="button" class="close" data-dismiss="modal" aria-label="Close">
								<span aria-hidden="true">&times;</span>
					 	...
					 	<form id="request_form">
						  	...
						  	<div class="modal-footer">
							   	<button type="button" class="btn btn-success" id="Submit_request">
							   		Send Request
							   	</button>
							   	<button type="button" class="btn btn-danger" data-dismiss="modal">
							   		Close
		...
		<div class="container">
			<center>
				<h1 style="font-family: 'Bangers'; font-size: 50px;">
					Events&nbsp;
					<span class="badge badge-info">
						pictures
					</span> 
					<i class="fa fa-camera-retro fa-1x">
					</i>
				</h1>
			</center>		
				...
				<div class="carousel-inner" role="listbox">
					<div class="carousel-item active">
					  	...
					  	<div class="carousel-caption d-none d-md-block">
							<h3 style="font-family: Frijole; color: lavender;">
								#SOIREE 1.
							</h3>  
					  	</div>
					</div>
		...
		<div class="container">
			<div class="jumbotron" style="background-color: pink; ">
				<h1 class="display-1">
			  	...
			  	<p class="lead">
			  		Come and join the party..Lets make the the day better together.
			  	</p>
			  	<hr class="my-4">
			  	<h4 class="text-primary">
			  		Send us a <b style="font-family: Margarine;">REQUEST</b> in case you are not invited. 
			  	</h4>
