...
<body style="background-color:transparent;">
	...
	<div class="container" style="font-family: 'Bangers'; font-size: 25px;">
		<h3 style="font-family: 'Paprika'; font-size: 50px;"">
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h3 class="modal-title" id="editModalLabel" style="font-family: 'Bangers'; font-size: 30px;">
							EDIT EVENT
						</h3>
					...
					<div class="modal-body" style="background-color: whitesmoke;">
						<form id="edit_event">
							...
							<div class="modal-footer">
								<button type="button" class="btn btn-success" name="update_event" id="update_event">
									Update
								</button>
