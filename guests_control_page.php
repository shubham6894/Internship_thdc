					...
					<div class="col-lg-8">
						<div class="container">
							<div style="width: 105%; border: 2px dashed whitesmoke; padding-bottom:45px;">
								<h5 style="font-family: 'Margarine'; font-size: 22px; padding-top:45px; ">
						    ...
						    <form id="guest_form">
							    <div class="form-group">
						  		...
						  		<div class="modal-footer">
								    <button type="button" class="btn btn-success" name="Submit" id="Submit_guests">
								    	Submit
								    </button>
				    ...
				    <div class="card-header" role="tablist" id="headingOne">
				      	<h5 class="mb-0">
					        <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
						        <center>
							        <h3 style="font-family: 'Bangers'; font-size: 40px;"> 
